...
// 					placeholder="Nimi"
// 					value={
// 						props.data.matiasClient && props.data.matiasClient.name
// 					}
// 				/>
// 				<label>Avain: </label>
// 				{props.data.matiasClient && props.data.matiasClient.key}
// 				<div style={{ marginBottom: "20px" }}>
// 					{props.data.matiasClient &&
// 					props.data.matiasClient.accepted ? (
// 						<Button
// 							bsStyle="danger"
// 							onClick={() => {
